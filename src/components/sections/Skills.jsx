...
export default function Skills({ darkMode }) {
  ...
  // Only fade + slide — NO scale to avoid zoom effect
  const opacity = useTransform(scrollYProgress, [0, 0.08, 0.88, 1], [0, 1, 1, 0]);
  const y = useTransform(scrollYProgress, [0, 0.08, 0.88, 1], [32, 0, 0, -24]);
  ...
  return (
    ...
    >
      ...
      {/* Dot grid texture removed for standardization */}
      ...
      <div style={{
        ...
        <motion.div
          style={{ opacity, y, width: "100%", maxWidth: 1320, padding: "0 2rem" }}
        >
          {/* Heading */}
